package com.evently.events.infrastructure.kafka.producer;
...
import static constants.KafkaTopics.*;
...
public class KafkaProducer {
    ...
    public void sendEventCreated(EventCreated message) {
    ...
    public void sendEventFinishedMessage(EventArchived message) {
        kafkaTemplate.send(EVENT_FINISHED, message);
    }

    public void sendNewLocationsAdded(EventUpdated message) {
